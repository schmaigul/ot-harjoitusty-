...
class TestUserRepository(unittest.TestCase):
    ...
    def test_create(self):
        user_repository.create_user(self.user_petteri)
    ...
    def test_find_user(self):
        user_repository.create_user(self.user_schmaigul)
        user_repository.create_user(self.user_petteri)

        user = user_repository.find_user(self.user_schmaigul.username)
        self.assertEqual("schmaigul", user.username)

        user2 = user_repository.find_user("petteri")
